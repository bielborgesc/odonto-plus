    ...
    <main class="container white-color texto">
        <form name="" action="" method="POST">
            <div class="form-group">
                ...
                <input  value="<?php echo $consultas[0]['Nome']; ?>" type="text" class="form-control" name="txtNome" id="nomeForm">
            </div>
            <div class="form-group">
                <label for="cpfForm">CPF</label>
                <input  type="text" value="<?php echo $consultas[0]['Cpf']; ?>" class="form-control" name="txtCpf" id="cpfForm">
            </div>
            <div class="form-group">
                <label for="telForm">Telefone</label>
                <input  type="number" value="<?php echo $consultas[0]['Telefone']; ?>" class="form-control" name="nbmTel" id="telForm">
            </div>
            <div class="form-group">
                <label for="emailForm">E-mail</label>
                <input  type="email" class="form-control" value="<?php echo $consultas[0]['Email']; ?>" name="txtEmail" id="emailForm">
            </div>
            <div class="form-group">
            ...
            <div class="form-group">
                ...
                <input  type="text" class="form-control" name="dteData" id="dataForm" value="<?php echo $consultas[0]['Data_con']; ?>">
            </div>
            <br>
            <div class="form-group">
                <label for="valorForm">Valor da Consulta:</label>
                <input  type="number" class="form-control" name="nbmValor" id="valorForm" value="<?php echo $consultas[0]['Valor']?>">
            </div>
            <div class="form-group">
            ...
            <h2 class="red-color">Deseja Mesmo Alterar?</h2><br>
            <button type="submit" class="btn btn-primary black-background" value="Alterar" name="btnOpcao">Alterar</button>
